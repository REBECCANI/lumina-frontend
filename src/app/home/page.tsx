    ...
    return (
        <div className="h-full my-12">
            <div className="flex justify-center items-center h-full">
                <div className="flex flex-col h-[80%] mt-[20px] bg-white w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] 2xl:w-[50%] bg-opacity-50 rounded-3xl shadow-xl mr-[100px]">
                    <div>
                        ...
                        <div>
                            <form onSubmit={sendMail} encType="multipart/form-data">
                                <div className="mx-4 sm:mx-8">
                                    ...
                                    <button
                                        type="submit"
                                        className="mt-6 mb-2 bg-gradient-to-r from-yellow-500 to-yellow-500 bg-hover-brown w-[40%] sm:w-[50%] lg:w-[40%] xl:w-[30%] 2xl:w-[25%] flex mx-auto py-2 rounded-full items-center justify-center text-white text-[18px] font-semibold"
                                    >
                                        Sign up
                                    </button>
                                </div>
